...
def open_window2():
  try:
    ...
    values =  splines_cuadratic.splines_cuadratic(vec_x,vec_y)
    global funtions
    funtions=values[0]
    global intervals
    intervals=values[1]
    etiqueta.config(text="Cuadratic splines done")
...
m_splines_linear.title("Cuadratic Splines Method")
...
bot= Button(vp, text="OK!", command=splines_cuadratic_click)
